page 55002 "Shipping MarkUp Setup"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(general)
            {
                ...
                field("MarkUp per For 1st Pallet";Rec."MarkUp per For 1st Pallet")
                {
                    ToolTip = 'Specifies the value of the MarkUp per For 1st Pallet field';
                    ApplicationArea = All;
                }
                field("MarkUp for Remaning Pallet";Rec."MarkUp for Remaning Pallet")
                {
                    ToolTip = 'Specifies the value of the MarkUp for Remaning Pallet field';
                    ApplicationArea = All;
                }
