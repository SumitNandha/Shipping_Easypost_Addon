table 55009 "Combine Rate Information"
{
    fields
    {
        ...
        field(4; Carrier; Text[100])
        {
            ...
            begin
                ...
                if ShippingAgents."Packing Type" = ShippingAgents."Packing Type"::Pallet then
                    Rec.validate("Markup Value", ShipPackageHeader."Pallet Markup value" + ShipPackageHeader."Additional Mark Up" + ShipPackageHeader."Insurance Markup for Pallet")
                else
                ...
                if not CombineRateInfo.FindSet() then begin
                    ...
                    if ShipPackageHeader."Inventory Pick" = '' then begin
                        if Rec."Choose Service" = true then begin
                            ...
                            ShippingAgents.SetRange("SI Get Rate Carrier", Rec.Carrier);
                            if ShippingAgents.FindFirst() then;
                            if ShippingAgents."Packing Type" = ShippingAgents."Packing Type"::Box then begin
