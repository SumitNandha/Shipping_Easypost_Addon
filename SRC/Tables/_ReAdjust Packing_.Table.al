table 55017 "ReAdjust Packing"
{
            ...
            begin
                if "Qty to Remove" <> 0 then begin
                    ...
                    IF PackinLines.FindFirst() then begin
                        ...
                        PackinLines.Validate("Qty in this Box", Rec."Qty to pack in this Box");
                    ...
                    PackingAdjustment.SetRange("Box ID", Rec."Box ID");
                    if PackingAdjustment.FindFirst() then begin
                        PackingAdjustment.Validate("Qty Packed in this Box", PackingAdjustment."Qty Packed in this Box" - Rec."Qty to Remove");
                    ...
                    if SubPackingLines.FindFirst() then begin
                        ...
                        Readjust.SetRange("Box ID", Rec."Box ID");
                        if Readjust.FindSet() then begin
                            SubPackingLines."Insurance price" := 0;
                            SubPackingLines."Qty Packed" := 0;
                            repeat
                                SubPackingLines."Insurance price" += Readjust."Insurance Price";
    ...
    keys
    {
        key(PK; "Packing No", "Box ID", "Line No.")
        {
            Clustered = true;
        }
    }
