table 55002 "Shipping MarkUp Setup"
{
    ...
    fields
    {
        ...
        field(3; "MarkUp per For 1st Pallet"; Decimal)
        {
            Caption = 'MarkUp per For 1st Pallet';
            DataClassification = ToBeClassified;
        }
        field(4; "MarkUp for Remaning Pallet"; Decimal)
        {
            Caption = 'MarkUp for Remaning Pallet';
            DataClassification = ToBeClassified;
        }
